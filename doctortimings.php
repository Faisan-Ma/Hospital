...
<div class="wrapper col2">
  <div id="breadcrumb">
    <ul>
      <li class="first">Add New Doctor Timing</li></ul>
  </div>
</div>
<div class="wrapper col4">
  <div id="container">
   ...
   <form method="post" action="" name="frmdocttimings" onSubmit="return validateform()">
    <table width="445" border="3" style="color:black">
      <tbody>
        <?php
        ...
        <tr>
          <td height="36" colspan="2" align="center"><input type="submit" name="submit" id="submit" style="border-radius: 25px; font-size:16px; font-weight: bold;" value="Submit" /></td>
        </tr>
      </tbody>
    </table>
    </form>
