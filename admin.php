...
<div class="wrapper col2">
  <div id="breadcrumb">
    <ul>
      <li class="first">Add Admin</li></ul>
  </div>
</div>
    ...
    <table width="200" border="3">
      <tbody style="color:black">
        <tr>
          ...
          <td width="66%"><input type="text" name="adminname" id="adminname" placeholder="Enter Admin Name" value="<?php echo $rsedit[adminname]; ?>"/></td>
        </tr>
        <tr>
          <td>Login ID</td>
        ...
        <tr>
          ...
          <td><input type="password" name="cnfirmpassword" id="cnfirmpassword" placeholder="Enter Password Again" value="<?php echo $rsedit[confirmpassword]; ?>"/></td>
        </tr>
        <tr>
          <td>Status</td>
