  ...
  <div id="container">
    ...
    <tbody style="color:black">
        <tr>
          ...
          <td width="66%"><input type="text" name="patientname" id="patientname"  placeholder="Enter Patient Name" value="<?php echo $rsedit[patientname]; ?>"/></td>
        </tr>
<?php
if(isset($_GET[editid]))
{
...
?>
        <tr>
          <td>Address</td>
          <td><textarea name="address" id="address" placeholder="  Enter Address" cols="60" rows="5"><?php echo $rsedit[address]; ?></textarea></td>
        </tr>
        <tr>
          <td>Mobile Number</td>
          <td><input type="text" name="mobilenumber" id="mobilenumber" placeholder="Ex : 0761234567" value="<?php echo $rsedit[mobileno]; ?>" /></td>
        </tr>
        <tr>
          <td>City</td>
          <td><input type="text" name="city" id="city" placeholder="Enter Your City" value="<?php echo $rsedit[city]; ?>" /></td>
        </tr>
        <tr>
          <td>PIN Code</td>
          <td><input type="text" name="pincode" id="pincode" placeholder="Enter PIN Code" value="<?php echo $rsedit[pincode]; ?>" /></td>
        </tr>
        <tr>
          <td>Login ID</td>
        ...
        <tr>
          ...
          <td><input type="password" name="confirmpassword" id="confirmpassword" placeholder="Enter Password Again" value="<?php echo $rsedit[confirmpassword]; ?>"/></td>
        </tr>
        <tr>
          <td>Blood Group</td>
        ...
        <tr>
          <td colspan="2" align="center"><input type="submit" name="submit" style="border-radius: 25px; font-size:16px; font-weight: bold;" id="submit" value="Submit" /></td>
		</tr>
      </tbody>
    </table>
    </form>
