...
<div class="wrapper col2">
  <div id="breadcrumb">
  <ul>
      <li class="first">Edit Patient Profile</li></ul>
  </div>
</div>
...
?>
        ...
        <tr>
          <td colspan="2" align="center"><input type="submit" name="submit" id="submit" style="border-radius: 25px; font-size:15px; font-weight: bold;"  value="Submit" /></td>
        </tr>
      </tbody>
    </table>
    </form>
