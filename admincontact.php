...
{  
	...
	sendmail("aaron98@gmail.com","Mail from Appoint My Doctor",$message);
...
<div class="wrapper col4">
  <div id="container">
        ...
        <h6>Contact Details</h6>
          ...
          <p>
            <input type="text" name="name" id="name" placeholder="Enter Your Name" value="" size="22" required />
            <label for="name"><small>Name (required)</small></label>
          </p>
          <p>
            <input type="text" name="email" id="email" placeholder="Enter Your Valid Email" value="" size="22" required />
            <label for="email"><small>Mail (required)</small></label>
          </p>
          <p>
            <textarea name="comment" name="Message" id="comment" placeholder=" Comments..." cols="95" rows="10" required></textarea>
            <label for="comment" style="display:none;"><small>Comment (required)</small></label>
          </p>
          <p>
            <input name="submit" type="submit" id="submit" style="border-radius: 25px; font-size:16px; font-weight: bold;" value="Submit"  />
            &nbsp;
            <input name="reset" type="reset" id="reset" tabindex="5" style="border-radius: 25px; font-size:16px; font-weight: bold;" value="Clear" />
          </p>
        </form>
