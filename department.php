...
<div class="wrapper col2" >
  <div id="breadcrumb">
    <ul>
      <li class="first">Add Department </li></ul>
  </div>
</div>
<div class="wrapper col4">
  <div id="container">
    ...
    <table width="418" border="3" style="color:black">
      <tbody>
        <tr>
          <td width="34%">Department Name</td>
          <td width="66%"><input type="text" name="departmentname" id="departmentname" placeholder="Enter Department Name" value="<?php echo $rsedit[departmentname]; ?>" /></td>
        </tr>
        <tr>
          <td>Description</td>
          <td><textarea name="textarea" id="textarea" placeholder="  About" cols="60" rows="5"><?php echo $rsedit[description] ; ?></textarea></td>
        </tr>
        <tr>
          <td>Status</td>
        ...
        <tr>
          <td colspan="2" align="center"><input type="submit" name="submit" id="submit" style="border-radius: 25px; font-size:16px; font-weight: bold;" value="Submit" /></td>
        </tr>
      </tbody>
    </table>
    </form>
